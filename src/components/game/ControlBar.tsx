...
const ControlBar: React.FC = () => {
  ...
  const toggleHeader = useCallback(() => updateSettings({ showHeader: !settings.showHeader }), [updateSettings, settings.showHeader]);
  const toggleSheetMusic = useCallback(() => updateSettings({ showSheetMusic: !settings.showSheetMusic }), [updateSettings, settings.showSheetMusic]);
