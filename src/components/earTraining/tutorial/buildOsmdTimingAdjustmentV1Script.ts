...
export const OSMD_TIMING_MQ_NORMAL_CONTENT_REF = 'mq-b1-q1-osmd-normal';
...
/** 通常 OSMD 用 UI（与ダメ／被ダメあり） */
export const mqOsmdNormalUi = (): EarTrainingTutorialUiOverrides => ({
...
export const resolveTimingAdjustmentSceneUi = (
  ...
  if (contentRef === OSMD_TIMING_MQ_NORMAL_CONTENT_REF) {
    return mqOsmdNormalUi();
  }
...
export const buildOsmdTimingAdjustmentV1Script = (): EarTrainingTutorialScriptPayload => ({
  ...
  content: {
    ...
    [OSMD_TIMING_MQ_NORMAL_CONTENT_REF]: {
      stage: {
        slug: OSMD_TIMING_MQ_NORMAL_CONTENT_REF,
        title: 'ドとソをまねしよう（通常）',
        title_en: 'Copy Do and Sol (battle)',
        bpm: 100,
        key_fifths: 0,
        beats_per_measure: 4,
        beat_type: 4,
      ...
      phrases: [
        {
          order_index: 0,
          title: 'Cブルース・ドとソ（通常）',
          title_en: 'C Blues Do/Sol (battle)',
          music_xml_url: 'https://jazzify-cdn.com/sozai/1-1.musicxml?v=20260623',
          audio_url: 'https://jazzify-cdn.com/sozai/Cblues_24bars_100BPM_count-in.mp3?v=20260623',
          loop_duration_sec: 60,
          audio_duration_sec: 60,
  ...
  scenes: [
    ...
    },
    {
      ...
      lines: [
        ...
        {
          speaker: 'partner',
          ja: 'では本番の課題じゃ。ドとソをまねしてみよ。',
          en: 'Next is the real task. Copy Do and Sol.',
        },
      ],
    },
    {
    ...
    {
      type: 'chord_osmd',
      contentRef: OSMD_TIMING_MQ_NORMAL_CONTENT_REF,
      requiredLoops: 1,
      timedLines: [],
    },
    {
      ...
      lines: [
        {
          speaker: 'partner',
          ja: '見事じゃ。ドとソで返事ができたのう。',
          en: 'Well done. You answered with Do and Sol.',
        },
        {
          speaker: 'player',
          ja: 'タイミング調整のおかげだね！',
          en: 'The timing adjustment really helped!',
        },
        {
          speaker: 'partner',
          ja: 'うむ。これで次も安心じゃ。',
          en: 'Aye. You are ready for what comes next.',
        },
      ],
    },
    { type: 'finish' },
