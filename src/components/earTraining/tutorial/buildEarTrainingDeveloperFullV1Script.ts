      ...
      phrases: [
        {
          ...
          chords: [
            ...
            },
            {
              ...
              voicing: [],
              voicing_staves: [],
              quote: { ja: '2 小節目：聴くだけ。', en: 'Measure 2: listen only.' },
            },
            {
              order_index: 2,
              chord_name: 'G7',
      ...
      phrase_pair_adlib: {
        ...
        steps: [
          ...
          },
          {
            ...
            end_time_sec: 2,
            input_disabled: true,
            quote: { ja: '2 小節目：聴くだけ', en: 'Measure 2: listen' },
          },
          {
            order_index: 2,
            chord_name: 'G7',
        ...
        patterns: [
          { group_key: 'cm7', label: 'A', pcs: [0, 2], family_id: 'CM7-A', carry_tail_length: 0, priority: 0 },
          { group_key: 'cm7', label: 'B', pcs: [4, 7], family_id: 'CM7-B', carry_tail_length: 0, priority: 0 },
        ],
      },
    },
    'tutorial-composite': {
  ...
  scenes: [
    ...
    },
    {
      ...
      timedLines: [
        ...
        { at: { loop: 0, measure: 2, beat: 1 }, text: { ja: 'アドリブ：聴くだけ', en: 'Adlib: listen' } },
      ],
    },
    {
