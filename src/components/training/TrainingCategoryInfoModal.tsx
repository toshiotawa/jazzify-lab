...
interface TrainingCategoryInfoModalProps {
  readonly title: string;
  readonly description: string;
  readonly onClose: () => void;
}

export const TrainingCategoryInfoModal: React.FC<TrainingCategoryInfoModalProps> = ({
  title,
  description,
  onClose,
}) => (
  <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/70 p-4">
    ...
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="training-category-info-title"
    >
      <h3 id="training-category-info-title" className="text-lg font-semibold text-white">{title}</h3>
