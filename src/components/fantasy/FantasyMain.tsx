  ...
  const gotoNextStageWaiting = useCallback(async () => {
    ...
    try {
      ...
      const convertedStage: FantasyStage = {
        ...
        rhythmMode: nextStageData.rhythm_mode as 'random' | 'progression' | undefined,
        ...
        chordProgressionData: nextStageData.chord_progression_data ? nextStageData.chord_progression_data : undefined,
