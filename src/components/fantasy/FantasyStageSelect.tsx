...
const RANK_COLORS: Record<string, string> = {
  ...
  '7': 'from-pink-700 to-pink-900',
  '8': 'from-yellow-700 to-yellow-900',
  '9': 'from-teal-700 to-teal-900',
  '10': 'from-gray-700 to-gray-900',
};
...
const RANK_DESCRIPTIONS: Record<string, string> = {
  '1': '魔法の基礎を学ぶ平和な森。メジャー・マイナーコードから7thコードまで、魔法使いとしての第一歩を踏み出そう。',
  '2': '青空の下で騎士たちが訓練する場所。メジャー7thやテンション系コード、ii-V-I進行など、より洗練された魔法を習得します。',
  '3': '紫水晶が輝く神秘的な迷宮。複雑なコード進行と高度なテンション、代理コードなど、魔導師への道を歩み始めます。',
  '4': '灼熱の炎を操る龍が住む危険な巣。ディミニッシュやオーグメント、モード奏法など、高度な魔法技術が要求されます。',
  '5': '黄金に輝く王国の宮殿。上級コード進行、リハーモナイゼーション、ポリコードなど、王国の魔法使いにふさわしい技術を磨きます。',
  '6': '古代の知識が詰まった禁断の魔導書。クロマチックアプローチ、アッパーストラクチャー、高度な転調技法を学びます。',
  '7': '桜の花びらが舞う美しい精霊界。繊細なボイシング、クラスターコード、現代的なハーモニーを習得します。',
  '8': '太陽神が宿る聖なる神殿。フュージョン系の複雑なコード、ポリリズム的な進行、高度な即興演奏技術を身につけます。',
  '9': '極寒の地に眠る古代の魔法。フリージャズ的なアプローチ、無調性、実験的なハーモニーに挑戦します。',
  '10': '歴代の英雄たちが集う最高峰の殿堂。すべての魔法を極め、新たな音楽の地平を切り開く伝説の魔法使いとなります。',
};
          ...
          <div className={cn(
            ...
            <div className="mt-6 bg-black bg-opacity-30 rounded-lg p-4">
              <div className="text-white text-sm">
                {RANK_DESCRIPTIONS[selectedRank]}
              </div>
            </div>
          </div>
        )}
