...
const legalEntries: LegalEntry[] = [
  ...
  },
  {
    label: '支払時期',
    value:
      '当社所定の条件に該当する初回利用者には、月額プラン及び年額プランのいずれにおいても、7日間の無料トライアル期間が付与される場合があります。トライアル期間中に解約手続を完了した場合、料金は発生しません。トライアル終了日の翌日に初回の料金が課金され、その後は申込み時に選択したプラン（月額プランは1か月ごと、年額プランは1年ごと）に自動で更新・決済されます。トライアルが付与されない場合は、お申込み完了後に所定の決済手続に基づき課金が開始され、その後も同様に自動更新されます。',
  },
  {
    label: '引渡し時期',
