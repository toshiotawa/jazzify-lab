      ...
      <main className="flex-1">
        <div className="container mx-auto px-6 py-12">
          ...
          <form name="contact" method="POST" data-netlify="true" data-netlify-honeypot="bot-field" className="space-y-4 max-w-xl">
            ...
            <p className="hidden">
              <label>{copy.honeypotLabel} <input name="bot-field" /></label>
            </p>
            <div>
            ...
            <button type="submit" className="px-6 py-2 rounded bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 font-bold">{copy.submitLabel}</button>
          </form>
        </div>
      </main>
