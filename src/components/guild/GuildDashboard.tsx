...
const GuildDashboard: React.FC = () => {
	...
	const getTitleIcon = (title: string) => {
		...
		switch (t) {
			...
			case 'mission': return <FaTrophy className="text-sm text紫-400"/>;
                                        ...
                                        <div className="max-w-4xl mx-auto space-y-4 text-center">
                                                ...
                                                {lastGuildInfo && (
                                                        <div className="mt-6 max-w-xl mx-auto text-left bg-slate-800 border border-slate-700 rounded p-4">
                                                                ...
                                                                <p className="text-sm text-gray-300">ギルド名「{lastGuildInfo.name}」から{lastGuildEvent === 'disband' ? '解散' : lastGuildEvent === 'kicked' ? '除名' : '脱退'}しました。</p>
                                                                <div className="mt-2">
