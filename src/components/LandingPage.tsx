...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="text-white" style={{ fontFamily: 'Noto Sans JP, system-ui, sans-serif' }}>
      <Helmet>
        <title>Jazzify - ジャズ異世界で始まる音楽冒険</title>
      </Helmet>

      {/* Header/Navigation */}
      <nav className="fixed top-0 w-full bg-slate-900 bg-opacity-90 backdrop-blur-md z-50 border-b border-purple-500 border-opacity-30">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
              <i className="fas fa-music mr-2" />Jazzify
            </h1>
            <div className="hidden md:flex space-x-6">
              <a href="#story" className="text-gray-300 hover:text-purple-400 transition">ストーリー</a>
              <a href="#modes" className="text-gray-300 hover:text-purple-400 transition">学習モード</a>
              <a href="#community" className="text-gray-300 hover:text-purple-400 transition">コミュニティ</a>
              <a href="#pricing" className="text-gray-300 hover:text-purple-400 transition">料金プラン</a>
      ...
      <section className="hero-bg min-h-screen flex items-center justify-center pt-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="magic-glow inline-block rounded-full p-1 bg-gradient-to-r from-purple-500 to-pink-500">
            <a href="#story" className="bg-slate-900 px-8 py-4 rounded-full text-xl font-bold hover:bg-slate-800 transition inline-block">
              <i className="fas fa-play mr-2" />冒険を始める
            </a>
          </div>
        </div>
      </section>
      ...
      {/* Story Section */}
      <section id="story" className="py-20 story-gradient scroll-offset">
        <div className="container mx-auto px-6">
          <h2 className="text-5xl font-bold text-center mb-16 section-title">
            <i className="fas fa-book-open mr-4" />Story
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="character-card rounded-2xl p-8 text-center floating-animation" style={{ animationDelay: '0.5s' }}>
              <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-green-400 to-teal-600 flex items-center justify-center">
                <i className="fas fa-guitar text-4xl text-white" />
              </div>
            ...
            <div className="character-card rounded-2xl p-8 text-center floating-animation" style={{ animationDelay: '1s' }}>
              <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-pink-400 to-red-600 flex items-center justify-center">
                <i className="fas fa-dragon text-4xl text-white" />
              </div>
      ...
      <section id="modes" className="py-20 scroll-offset">
        <div className="container mx-auto px-6">
          <h2 className="text-5xl font-bold text-center mb-16 section-title">
            <i className="fas fa-gamepad mr-4" />学習モード
          </h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="feature-card rounded-2xl p-8 magic-glow">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><i className="fas fa-star text-yellow-400 mr-2" />巨匠の演奏を完全再現</li>
                <li><i className="fas fa-star text-yellow-400 mr-2" />楽譜とタブ譜表示</li>
                <li><i className="fas fa-star text-yellow-400 mr-2" />スロー再生機能</li>
                <li><i className="fas fa-star text-yellow-400 mr-2" />フレーズ分析機能</li>
              </ul>
            </div>
            ...
            <div className="feature-card rounded-2xl p-8 magic-glow">
              <div className="text-center mb-6">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple-400 to-pink-600 flex items-center justify-center">
                  <i className="fas fa-magic text-2xl text-white" />
                </div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><i className="fas fa-magic text-purple-400 mr-2" />RPG風コード学習</li>
                <li><i className="fas fa-magic text-purple-400 mr-2" />セッションバトル</li>
                <li><i className="fas fa-magic text-purple-400 mr-2" />スキルツリーシステム</li>
                <li><i className="fas fa-magic text-purple-400 mr-2" />アイテム収集機能</li>
              </ul>
            </div>
            ...
            <div className="feature-card rounded-2xl p-8 magic-glow">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><i className="fas fa-video text-blue-400 mr-2" />HD動画レッスン</li>
                <li><i className="fas fa-video text-blue-400 mr-2" />段階的カリキュラム</li>
                <li><i className="fas fa-video text-blue-400 mr-2" />課題チェック機能</li>
                <li><i className="fas fa-video text-blue-400 mr-2" />進捗管理システム</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      {/* Community Section */}
      <section id="community" className="py-20 story-gradient scroll-offset">
        <div className="container mx-auto px-6">
          <h2 className="text-5xl font-bold text-center mb-16 section-title">
            <i className="fas fa-users mr-4" />コミュニティ機能
          </h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="feature-card rounded-2xl p-8">
              <div className="text-center mb-6">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-green-400 to-emerald-600 flex items-center justify-center">
                  <i className="fas fa-book text-2xl text-white" />
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-edit text-green-400 mr-3" />日記投稿・編集機能</div>
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-comment text-green-400 mr-3" />コメント機能</div>
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-heart text-green-400 mr-3" />いいね機能</div>
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-share text-green-400 mr-3" />SNS共有機能</div>
              </div>
            </div>
            ...
            <div className="feature-card rounded-2xl p-8">
              ...
              <div className="space-y-3">
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-star text-orange-400 mr-3" />レベルアップシステム</div>
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-unlock text-orange-400 mr-3" />コンテンツアンロック</div>
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-medal text-orange-400 mr-3" />バッジ獲得システム</div>
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-chart-line text-orange-400 mr-3" />成長グラフ表示</div>
              </div>
            </div>
            ...
            <div className="feature-card rounded-2xl p-8">
              <div className="text-center mb-6">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple-400 to-indigo-600 flex items-center justify-center">
                  <i className="fas fa-ranking-star text-2xl text-white" />
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-list text-purple-400 mr-3" />総合ランキング</div>
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-calendar text-purple-400 mr-3" />月間ランキング</div>
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-music text-purple-400 mr-3" />楽器別ランキング</div>
                <div className="flex items-center text-sm text-gray-400"><i className="fas fa-crown text-purple-400 mr-3" />殿堂入りシステム</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 scroll-offset">
        <div className="container mx-auto px-6">
          <h2 className="text-5xl font-bold text-center mb-16 section-title">
            <i className="fas fa-cogs mr-4" />対応機種・技術仕様
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            <div className="feature-card rounded-xl p-6 text-center">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                <i className="fas fa-mobile-alt text-xl text-white" />
              </div>
            ...
            <div className="feature-card rounded-xl p-6 text-center">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                <i className="fas fa-desktop text-xl text-white" />
              </div>
            ...
            <div className="feature-card rounded-xl p-6 text-center">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center">
                <i className="fas fa-piano text-xl text-white" />
              </div>
            ...
            <div className="feature-card rounded-xl p-6 text-center">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br from-pink-400 to-pink-600 flex items-center justify-center">
                <i className="fas fa-microphone text-xl text-white" />
              </div>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 story-gradient scroll-offset">
        <div className="container mx-auto px-6">
          <h2 className="text-5xl font-bold text-center mb-16 section-title">
            <i className="fas fa-gem mr-4" />料金プラン
          </h2>
          ...
          <div className="grid lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="pricing-card rounded-2xl p-8 text-center">
              ...
              <ul className="space-y-3 text-sm text-gray-400 mb-8">
                <li><i className="fas fa-check text-green-400 mr-2" />基本レッスン（10回まで）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />ファンタジーモード（Lv.5まで）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />練習日記（月5投稿）</li>
                <li><i className="fas fa-times text-red-400 mr-2" />レジェンドモード</li>
                <li><i className="fas fa-times text-red-400 mr-2" />MIDI接続</li>
              </ul>
              <button className="w-full py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-500 transition">無料で始める</button>
            </div>
            ...
            <div className="pricing-card rounded-2xl p-8 text-center">
              ...
              <ul className="space-y-3 text-sm text-gray-400 mb-8">
                <li><i className="fas fa-check text-green-400 mr-2" />基本レッスン（無制限）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />ファンタジーモード（無制限）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />練習日記（無制限）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />レジェンドモード（3曲まで）</li>
                <li><i className="fas fa-times text-red-400 mr-2" />MIDI接続</li>
              </ul>
              <button className="w-full py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">スタンダードを選ぶ</button>
            </div>
            ...
            <div className="pricing-card premium rounded-2xl p-8 text-center transform scale-105">
              ...
              <ul className="space-y-3 text-sm text-gray-400 mb-8">
                <li><i className="fas fa-check text-green-400 mr-2" />全レッスン（無制限）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />ファンタジーモード（無制限）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />コミュニティ機能（全て）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />レジェンドモード（無制限）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />MIDI接続</li>
              </ul>
              <button className="w-full py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-bold rounded-lg hover:from-yellow-400 hover:to-orange-400 transition">プレミアムを選ぶ</button>
            </div>
            ...
            <div className="pricing-card rounded-2xl p-8 text-center">
              ...
              <ul className="space-y-3 text-sm text-gray-400 mb-8">
                <li><i className="fas fa-check text-green-400 mr-2" />全機能（無制限）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />個人レッスン（月2回）</li>
                <li><i className="fas fa-check text-green-400 mr-2" />専用コンシェルジュ</li>
                <li><i className="fas fa-check text-green-400 mr-2" />楽譜ダウンロード</li>
                <li><i className="fas fa-check text-green-400 mr-2" />優先サポート</li>
              </ul>
              <button className="w-full py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-500 transition">プラチナを選ぶ</button>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-20 scroll-offset">
        <div className="container mx-auto px-6">
          <h2 className="text-5xl font-bold text-center mb-16 section-title">
            <i className="fas fa-question-circle mr-4" />よくある質問
          </h2>
            ...
            {[1,2,3,4,5].map((id) => (
              <div key={id} className="faq-item rounded-xl p-6">
                <div className="flex items-center justify-between cursor-pointer" onClick={() => toggleFAQ(id)}>
                  ...
                  <i className={`fas ${openFaq[id] ? 'fa-chevron-up' : 'fa-chevron-down'} text-purple-400`} />
                </div>
                <div className={`mt-4 text-gray-400 ${openFaq[id] ? '' : 'hidden'}`}>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="#modes" className="hover:text-purple-400 transition">学習モード</a></li>
                <li><a href="#community" className="hover:text-purple-400 transition">コミュニティ</a></li>
                <li><a href="#pricing" className="hover:text-purple-400 transition">料金プラン</a></li>
                <li><a href="#" className="hover:text-purple-400 transition">無料体験</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="#faq" className="hover:text-purple-400 transition">よくある質問</a></li>
                <li><a href="#" className="hover:text-purple-400 transition">お問い合わせ</a></li>
                <li><a href="#" className="hover:text-purple-400 transition">利用規約</a></li>
                <li><a href="#" className="hover:text-purple-400 transition">プライバシーポリシー</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-gray-400 hover:text-purple-400 transition"><i className="fab fa-twitter text-xl" /></a>
                <a href="#" className="text-gray-400 hover:text-purple-400 transition"><i className="fab fa-facebook text-xl" /></a>
                <a href="#" className="text-gray-400 hover:text-purple-400 transition"><i className="fab fa-youtube text-xl" /></a>
                <a href="#" className="text-gray-400 hover:text-purple-400 transition"><i className="fab fa-instagram text-xl" /></a>
              </div>
            </div>
          </div>
