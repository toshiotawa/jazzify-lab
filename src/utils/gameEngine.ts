...
import { unifiedFrameController, frameScheduler } from './performanceOptimizer';
...
export class GameEngine {
  ...
  private startGameLoop(): void {
    ...
    this.frameLoopUnsubscribe = frameScheduler.subscribe(({ time }) => {
      this.runGameLoopFrame(time);
    });
  }
  ...
  private runGameLoopFrame(frameStartTime: number): void {
