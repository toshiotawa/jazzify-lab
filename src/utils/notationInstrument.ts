...
export const NOTATION_INSTRUMENT_PRESETS = [
  ...
  { id: 'soprano_sax', clef: 'treble', transposition: -2, octaveOffset: 0, label: { ja: 'ソプラノサックス in B♭', en: 'Soprano Sax in B♭' } },
  { id: 'alto_sax', clef: 'treble', transposition: -9, octaveOffset: 0, label: { ja: 'アルトサックス in E♭', en: 'Alto Sax in E♭' } },
  { id: 'tenor_sax', clef: 'treble', transposition: -2, octaveOffset: -1, label: { ja: 'テナーサックス in B♭', en: 'Tenor Sax in B♭' } },
  { id: 'baritone_sax', clef: 'treble', transposition: -9, octaveOffset: -1, label: { ja: 'バリトンサックス in E♭', en: 'Baritone Sax in E♭' } },
