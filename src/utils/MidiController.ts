...
export const initializeAudioSystem = async (): Promise<void> => {
  ...
  try {
    ...
    globalSampler = new Tone.PolySynth(Tone.Synth, DEFAULT_SYNTH_OPTIONS).toDestination();
...
export const upgradeAudioSystemToFull = async (): Promise<void> => {
  console.log('🎹 upgradeAudioSystemToFull is disabled: lightweight synth is always used.');
};
