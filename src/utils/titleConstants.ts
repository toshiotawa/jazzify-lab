...
export const WIZARD_TITLES = [
  ...
  'グランドルーン',         // 640-649
  '星詠みの学者',           // 650-659
  'アカシック・ヴィジョナー', // 660-669
  'サモナー・ロード',       // 670-679
  '魔力暴走',               // 680-689
  'ロイヤル・プロフェッサー', // 690-699
  '神託の巫女/神官',        // 700-709
  'ソーサラー・キング',     // 710-719
  'エーテルネクサス',       // 720-729
  'セージ',                 // 730-739
  '次元潜行者',             // 740-749
  'ウォーロック・オーバーロード', // 750-759
  'マナダイヤモンド',       // 760-769
  'アカデメイアの賢者',     // 770-779
  '神秘王',                 // 780-789
  'ロード・オブ・メイジ',   // 790-799
  ...
  'アカシック・リーダー',   // 890-899
  'コズミック・オラクル',   // 900-909
  'アルティメット・ソーサラー', // 910-919
  'ルーンの創造主',         // 920-929
  '真理の探究者',           // 930-939
  'アストラル・ロード',     // 940-949
  'エレメンタル・エンペラー', // 950-959
  '星屑の魔力',             // 960-969
  '星図の編纂者',           // 970-979
  '聖別の執行者',           // 980-989
  'アークリッチ',           // 990-999
  ...
  '大賢者の魔法使い',       // 1070-1079
  'アークデーモン',         // 1080-1089
  'グランド・ワイズマン',   // 1090-1099
  'アカシック・ダイバー',   // 1100-1109
  'キング・オブ・ウィザーズ', // 1110-1119
  '銀河のマナ',             // 1120-1129
  'アカデメイアの主',       // 1130-1139
  '運命の紡ぎ手',           // 1140-1149
  '絶望の魔術師',           // 1150-1159
  'コズミック・エーテル',   // 1160-1169
  '根源の学者',             // 1170-1179
  '神秘神',                 // 1180-1189
  '魔法神の使徒',           // 1190-1199
  '魔力次元',               // 1200-1209
  ...
  '魔法騎士団長',           // 1230-1239
  'ルーンの法則',           // 1240-1249
  'アカシック・レコードの閲覧者', // 1250-1259
  'コズミック・エンペラー', // 1260-1269
  'グランド・アークメイジ', // 1270-1279
  'マナの特異点',           // 1280-1289
  '賢王',                   // 1290-1299
  'ディヴァイン・ソース',   // 1300-1309
  '希望の魔術師',           // 1310-1319
  'ヴォイドルーラー',       // 1320-1329
  '星界の哲学者',           // 1330-1339
  '時空の航海士',           // 1340-1349
...
export function getTitleRequirement(titleName: string): string {
  ...
  if (warriorIndex !== -1) {
    const minClears = warriorIndex * 10;
    if (warriorIndex === 0) {
