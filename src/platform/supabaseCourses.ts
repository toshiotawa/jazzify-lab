...
import { evaluateCourseAccess, areCoursePrerequisitesMet, UserRank } from '@/utils/lessonAccess';
...
export { areCoursePrerequisitesMet };
...
export function canAccessCourse(
  ...
  const { canAccess, reason } = evaluateCourseAccess({
    course,
    userRank,
    completedCourseIds,
  ...
  return reason ? { canAccess, reason } : { canAccess };
}
