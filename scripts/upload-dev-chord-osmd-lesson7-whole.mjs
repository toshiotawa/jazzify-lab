/**
 * 開発者用 chord_osmd レッスン7: Finale 製の全音符 4 小節 MusicXML を R2 にアップロード。
 *
 * 入力: public/demo lesson7.musicxml
 * 出力: R2 の fantasy-bgm/ear-training-dev-chord-osmd-120-lesson7-whole.musicxml
 *
 * Usage:
 *   node scripts/upload-dev-chord-osmd-lesson7-whole.mjs
 *   node scripts/upload-dev-chord-osmd-lesson7-whole.mjs --dry-run
 *   node scripts/upload-dev-chord-osmd-lesson7-whole.mjs --purge-cdn
 *   node scripts/upload-dev-chord-osmd-lesson7-whole.mjs --s3
 */
...
const SRC_PATH = join(ROOT, 'public', 'demo lesson7.musicxml');
const DEST_KEY = 'fantasy-bgm/ear-training-dev-chord-osmd-120-lesson7-whole.musicxml';
