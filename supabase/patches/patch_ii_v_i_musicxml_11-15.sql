-- patch music_xml + production_start_key for range 11-15
...
<score-partwise version="3.1">
  ...
  production_start_key = CASE id
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-c-11-15') THEN 0
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-f-11-15') THEN 5
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-bb-11-15') THEN -2
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-eb-11-15') THEN 3
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-ab-11-15') THEN -4
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-db-11-15') THEN 1
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-gb-11-15') THEN 6
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-b-11-15') THEN -1
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-e-11-15') THEN 4
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-a-11-15') THEN -3
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-d-11-15') THEN 2
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-g-11-15') THEN -5
