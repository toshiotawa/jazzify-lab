-- II-V-I non-C music_xml batch: 26-30 (11 stages)
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-f-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-bb-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-eb-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-ab-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-db-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-gb-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-b-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-e-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-a-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-d-26-30');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-g-26-30');
