-- II-V-I non-C music_xml batch: 31-35 (11 stages)
UPDATE public.fantasy_stages
SET music_xml = $musicxml$<?xml version='1.0' encoding='utf-8'?>
<score-partwise version="3.1">
  <identification>
    <rights>©</rights>
    <encoding>
      <software>Finale v26.3 for Windows</software>
      <encoding-date>2026-03-25</encoding-date>
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-f-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-bb-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-eb-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-ab-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-db-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-gb-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-b-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-e-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-a-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-d-31-35');
...
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-g-31-35');
