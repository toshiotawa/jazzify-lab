-- patch music_xml + production_start_key for range 36-40
...
<score-partwise version="3.1">
  ...
  production_start_key = CASE id
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-c-36-40') THEN 0
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-f-36-40') THEN 5
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-bb-36-40') THEN -2
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-eb-36-40') THEN 3
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-ab-36-40') THEN -4
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-db-36-40') THEN 1
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-gb-36-40') THEN 6
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-b-36-40') THEN -1
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-e-36-40') THEN 4
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-a-36-40') THEN -3
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-d-36-40') THEN 2
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-g-36-40') THEN -5
