-- patch music_xml + production_start_key for range 41-45
...
<score-partwise version="3.1">
  ...
  production_start_key = CASE id
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-c-41-45') THEN 0
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-f-41-45') THEN 5
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-bb-41-45') THEN -2
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-eb-41-45') THEN 3
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-ab-41-45') THEN -4
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-db-41-45') THEN 1
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-gb-41-45') THEN 6
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-b-41-45') THEN -1
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-e-41-45') THEN 4
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-a-41-45') THEN -3
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-d-41-45') THEN 2
    WHEN uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'st-g-41-45') THEN -5
