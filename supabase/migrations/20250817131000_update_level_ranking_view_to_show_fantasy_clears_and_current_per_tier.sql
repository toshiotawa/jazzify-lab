-- Update level ranking view to include per-tier current stages
...
SELECT
  ...
  f.current_stage_number_basic,
  f.current_stage_number_advanced,
...
LEFT JOIN (
  SELECT fup.user_id,
         fup.current_stage_number,
         fup.current_stage_number_basic,
         fup.current_stage_number_advanced
