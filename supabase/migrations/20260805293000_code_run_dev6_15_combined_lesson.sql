...
SELECT
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'course-developer-test'),
  'サバイバル: コードラン dev6〜15（テスト）',
  'Survival: Code Run dev6–15 (test)',
  '開発用コードランマップ dev_run_06 から dev_run_15 までを順にプレイする10課題の統合レッスンです。',
  'Combined developer test lesson with ten Code Run assignments for dev_run_06 through dev_run_15.',
  false,
  ...
  'Test',
  '[]'::jsonb,
  '各課題を順番にクリアしてください。制限時間内にゴールの旗に触れればクリアです。',
  'Clear each assignment in order. Reach the goal flag before the time limit.'
FROM (
...
INSERT INTO public.lesson_songs (
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-06'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    0,
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-07'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    1,
    '{"count":1,"rank":"C"}'::jsonb,
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-08'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    2,
    '{"count":1,"rank":"C"}'::jsonb,
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-09'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    3,
    '{"count":1,"rank":"C"}'::jsonb,
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-10'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    4,
    '{"count":1,"rank":"C"}'::jsonb,
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-11'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    5,
    '{"count":1,"rank":"C"}'::jsonb,
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-12'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    6,
    '{"count":1,"rank":"C"}'::jsonb,
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-13'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    7,
    '{"count":1,"rank":"C"}'::jsonb,
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-14'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    8,
    '{"count":1,"rank":"C"}'::jsonb,
  ...
  (
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lsong-15'),
    uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-dev6-15-lesson'),
    NULL,
    9,
    '{"count":1,"rank":"C"}'::jsonb,
