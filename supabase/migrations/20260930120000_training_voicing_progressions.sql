...
INSERT INTO public.trainings (
  ...
  (
    ...
    uuid_generate_v5('b0000000-0000-4000-8000-000000000001'::uuid, 'training-category-lh_voicing_progression'),
    'lh-ii-v-i-all-key',
    'II-V-I in All Key(最適配置)',
    'II-V-I in All Keys (Optimal Voicing)',
    1,
    'progression',
    'bass_concert',
    true,
  ...
  (
    ...
    'II-V(alt)-I in All Key(最適配置)',
    'II-V(alt)-I in All Keys (Optimal Voicing)',
    2,
    'progression',
    'bass_concert',
    true,
  ...
  (
    ...
    'Minor II-V-I in All Key(最適配置)',
    'Minor II-V-I in All Keys (Optimal Voicing)',
    3,
    'progression',
    'bass_concert',
    true,
