...
SET
  run_map_id = 'tutorial',
  name = '開発: Tutorial',
  name_en = 'Dev: Tutorial',
  chord_display_name = 'Tutorial',
  chord_display_name_en = 'Tutorial',
  updated_at = now()
...
SET
  title = 'サバイバル: Tutorial（テスト）',
  title_en = 'Survival: Tutorial (test)',
  updated_at = now()
...
SET
  title = '課題（Tutorial）',
  title_en = 'Assignment (Tutorial)',
  updated_at = now()
WHERE id = uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-03-lsong');

DELETE FROM public.survival_run_maps
