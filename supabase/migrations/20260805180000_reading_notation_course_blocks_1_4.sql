...
INSERT INTO public.ear_training_stages (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q3'),
  'notation-quiz-b2-q3',
  '譜読みクイズ: シドレ',
  'Sight-reading quiz: B C D',
  '30秒以内に30問正解。譜面の音符を読んで弾きましょう。',
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b2-q3-0'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q3'),
  0, 1, 1, 4,
  'B5',
  ARRAY['B5']::text[],
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b2-q3-1'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q3'),
  1, 2, 1, 4,
  'C6',
  ARRAY['C6']::text[],
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b2-q3-2'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q3'),
  2, 3, 1, 4,
  'D6',
  ARRAY['D6']::text[],
...
INSERT INTO public.ear_training_stages (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q4'),
  'notation-quiz-b2-q4',
  '譜読みクイズ: ドレミ',
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b2-q4-0'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q4'),
  0, 1, 1, 4,
  'C6',
  ARRAY['C6']::text[],
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b2-q4-1'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q4'),
  1, 2, 1, 4,
  'D6',
  ARRAY['D6']::text[],
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b2-q4-2'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q4'),
  2, 3, 1, 4,
  'E6',
  ARRAY['E6']::text[],
...
INSERT INTO public.ear_training_stages (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q3'),
  'notation-quiz-b3-q3',
  '譜読みクイズ: ラシド',
  'Sight-reading quiz: A B C',
  '30秒以内に30問正解。譜面の音符を読んで弾きましょう。',
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b3-q3-0'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q3'),
  0, 1, 1, 4,
  'A3',
  ARRAY['A3']::text[],
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b3-q3-1'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q3'),
  1, 2, 1, 4,
  'B3',
  ARRAY['B3']::text[],
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b3-q3-2'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q3'),
  2, 3, 1, 4,
  'C4',
  ARRAY['C4']::text[],
...
INSERT INTO public.ear_training_stages (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q4'),
  'notation-quiz-b3-q4',
  '譜読みクイズ: シドレ',
  'Sight-reading quiz: B C D',
  '30秒以内に30問正解。譜面の音符を読んで弾きましょう。',
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b3-q4-0'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q4'),
  0, 1, 1, 4,
  'B3',
  ARRAY['B3']::text[],
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b3-q4-1'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q4'),
  1, 2, 1, 4,
  'C4',
  ARRAY['C4']::text[],
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b3-q4-2'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q4'),
  2, 3, 1, 4,
  'D4',
  ARRAY['D4']::text[],
...
INSERT INTO public.ear_training_chord_quiz_items (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-item-b4-q1-20'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b4-q1'),
  20, 21, 1, 4,
  'D4',
  ARRAY['D4']::text[],
...
INSERT INTO public.lessons (
  ...
  'ミファソ',
  'E F G',
  'ト音記号・五線の中。下から2番目の線（ミ）から、ファ・ソまで読みましょう。

このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, notes on the staff. Read E, F, and G from the second line up.

In this quest: ① Balloon Rush → ② Survival → ③ Battle mode.',
  true,
  0, 1,
  '五線の中の音符（ト音記号）', 'Treble clef: notes on the staff',
  'ト音記号の五線の中の音符を、3音ずつ覚えていきます。', 'Learn treble-clef notes on the staff, three at a time.',
  '[]'::jsonb,
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b1-q1-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b1-q1'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   ...
   '[{"name":"E4","voicing":[64],"voicing_names":["E4"],"voicing_staves":[1],"key_fifths":0},{"name":"F4","voicing":[65],"voicing_names":["F4"],"voicing_staves":[1],"key_fifths":0},{"name":"G4","voicing":[67],"voicing_names":["G4"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b1-q1-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b1-q1'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   ...
   '[{"name":"E4","voicing":[64],"voicing_names":["E4"],"voicing_staves":[1],"key_fifths":0},{"name":"F4","voicing":[65],"voicing_names":["F4"],"voicing_staves":[1],"key_fifths":0},{"name":"G4","voicing":[67],"voicing_names":["G4"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
...
INSERT INTO public.lessons (
  ...
  'ソラシ',
  'G A B',
  'ト音記号・五線の中。ソ・ラ・シの3音です。

このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, notes on the staff: G, A, and B.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b1-q2-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b1-q2'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"G4","voicing":[67],"voicing_names":["G4"],"voicing_staves":[1],"key_fifths":0},{"name":"A4","voicing":[69],"voicing_names":["A4"],"voicing_staves":[1],"key_fifths":0},{"name":"B4","voicing":[71],"voicing_names":["B4"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b1-q2-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b1-q2'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"G4","voicing":[67],"voicing_names":["G4"],"voicing_staves":[1],"key_fifths":0},{"name":"A4","voicing":[69],"voicing_names":["A4"],"voicing_staves":[1],"key_fifths":0},{"name":"B4","voicing":[71],"voicing_names":["B4"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
...
INSERT INTO public.lessons (
  ...
  'シドレ',
  'B C D',
  'ト音記号・五線の中。シからレまで読みましょう。

このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, notes on the staff: B, C, and D.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b1-q3-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b1-q3'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"B4","voicing":[71],"voicing_names":["B4"],"voicing_staves":[1],"key_fifths":0},{"name":"C5","voicing":[72],"voicing_names":["C5"],"voicing_staves":[1],"key_fifths":0},{"name":"D5","voicing":[74],"voicing_names":["D5"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b1-q3-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b1-q3'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"B4","voicing":[71],"voicing_names":["B4"],"voicing_staves":[1],"key_fifths":0},{"name":"C5","voicing":[72],"voicing_names":["C5"],"voicing_staves":[1],"key_fifths":0},{"name":"D5","voicing":[74],"voicing_names":["D5"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
...
INSERT INTO public.lessons (
  ...
  'レミファ',
  'D E F',
  'ト音記号・五線の中。レ・ミ・ファの3音です。

このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, notes on the staff: D, E, and F.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b1-q4-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b1-q4'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"D5","voicing":[74],"voicing_names":["D5"],"voicing_staves":[1],"key_fifths":0},{"name":"E5","voicing":[76],"voicing_names":["E5"],"voicing_staves":[1],"key_fifths":0},{"name":"F5","voicing":[77],"voicing_names":["F5"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b1-q4-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b1-q4'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"D5","voicing":[74],"voicing_names":["D5"],"voicing_staves":[1],"key_fifths":0},{"name":"E5","voicing":[76],"voicing_names":["E5"],"voicing_staves":[1],"key_fifths":0},{"name":"F5","voicing":[77],"voicing_names":["F5"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
...
INSERT INTO public.lessons (
  ...
  'ソラシ',
  'G A B',
  'ト音記号・上加線。五線の上のソ・ラ・シです。

このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, upper ledger lines: G, A, and B.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q1-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q1'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"G5","voicing":[79],"voicing_names":["G5"],"voicing_staves":[1],"key_fifths":0},{"name":"A5","voicing":[81],"voicing_names":["A5"],"voicing_staves":[1],"key_fifths":0},{"name":"B5","voicing":[83],"voicing_names":["B5"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q1-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q1'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"G5","voicing":[79],"voicing_names":["G5"],"voicing_staves":[1],"key_fifths":0},{"name":"A5","voicing":[81],"voicing_names":["A5"],"voicing_staves":[1],"key_fifths":0},{"name":"B5","voicing":[83],"voicing_names":["B5"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
...
このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, upper ledger lines: A, B, and C.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q2-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q2'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"A5","voicing":[81],"voicing_names":["A5"],"voicing_staves":[1],"key_fifths":0},{"name":"B5","voicing":[83],"voicing_names":["B5"],"voicing_staves":[1],"key_fifths":0},{"name":"C6","voicing":[84],"voicing_names":["C6"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q2-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q2'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"A5","voicing":[81],"voicing_names":["A5"],"voicing_staves":[1],"key_fifths":0},{"name":"B5","voicing":[83],"voicing_names":["B5"],"voicing_staves":[1],"key_fifths":0},{"name":"C6","voicing":[84],"voicing_names":["C6"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
...
INSERT INTO public.lessons (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q3'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'course-reading-notation'),
  'シドレ',
  'B C D',
  'ト音記号・上加線。シ・ド・レを読みましょう。

このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, upper ledger lines: B, C, and D.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q3-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q3'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"B5","voicing":[83],"voicing_names":["B5"],"voicing_staves":[1],"key_fifths":0},{"name":"C6","voicing":[84],"voicing_names":["C6"],"voicing_staves":[1],"key_fifths":0},{"name":"D6","voicing":[86],"voicing_names":["D6"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q3-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q3'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"B5","voicing":[83],"voicing_names":["B5"],"voicing_staves":[1],"key_fifths":0},{"name":"C6","voicing":[84],"voicing_names":["C6"],"voicing_staves":[1],"key_fifths":0},{"name":"D6","voicing":[86],"voicing_names":["D6"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q3-battle'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q3'), NULL, 2, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, false, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q3'), NULL, NULL,
   'バトルモード', 'Battle mode', true)
ON CONFLICT (id) DO UPDATE SET
  order_index = EXCLUDED.order_index,
  survival_random_chords = EXCLUDED.survival_random_chords,
...
INSERT INTO public.lessons (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q4'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'course-reading-notation'),
  'ドレミ',
  'C D E',
  'ト音記号・上加線。ド・レ・ミの3音です。
...
このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, upper ledger lines: C, D, and E.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q4-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q4'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"C6","voicing":[84],"voicing_names":["C6"],"voicing_staves":[1],"key_fifths":0},{"name":"D6","voicing":[86],"voicing_names":["D6"],"voicing_staves":[1],"key_fifths":0},{"name":"E6","voicing":[88],"voicing_names":["E6"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q4-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q4'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"C6","voicing":[84],"voicing_names":["C6"],"voicing_staves":[1],"key_fifths":0},{"name":"D6","voicing":[86],"voicing_names":["D6"],"voicing_staves":[1],"key_fifths":0},{"name":"E6","voicing":[88],"voicing_names":["E6"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b2-q4-battle'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b2-q4'), NULL, 2, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, false, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b2-q4'), NULL, NULL,
   'バトルモード', 'Battle mode', true)
ON CONFLICT (id) DO UPDATE SET
  order_index = EXCLUDED.order_index,
  survival_random_chords = EXCLUDED.survival_random_chords,
...
INSERT INTO public.lessons (
  ...
  'ファソラ',
  'F G A',
  'ト音記号・下加線。ファ・ソ・ラの3音です。

このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, lower ledger lines: F, G, and A.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q1-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q1'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"F3","voicing":[53],"voicing_names":["F3"],"voicing_staves":[1],"key_fifths":0},{"name":"G3","voicing":[55],"voicing_names":["G3"],"voicing_staves":[1],"key_fifths":0},{"name":"A3","voicing":[57],"voicing_names":["A3"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q1-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q1'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"F3","voicing":[53],"voicing_names":["F3"],"voicing_staves":[1],"key_fifths":0},{"name":"G3","voicing":[55],"voicing_names":["G3"],"voicing_staves":[1],"key_fifths":0},{"name":"A3","voicing":[57],"voicing_names":["A3"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
...
INSERT INTO public.lessons (
  ...
  'ソラシ',
  'G A B',
  'ト音記号・下加線。ソ・ラ・シを読みましょう。

このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, lower ledger lines: G, A, and B.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q2-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q2'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"G3","voicing":[55],"voicing_names":["G3"],"voicing_staves":[1],"key_fifths":0},{"name":"A3","voicing":[57],"voicing_names":["A3"],"voicing_staves":[1],"key_fifths":0},{"name":"B3","voicing":[59],"voicing_names":["B3"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q2-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q2'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"G3","voicing":[55],"voicing_names":["G3"],"voicing_staves":[1],"key_fifths":0},{"name":"A3","voicing":[57],"voicing_names":["A3"],"voicing_staves":[1],"key_fifths":0},{"name":"B3","voicing":[59],"voicing_names":["B3"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
...
INSERT INTO public.lessons (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q3'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'course-reading-notation'),
  'ラシド',
  'A B C',
  'ト音記号・下加線。ラ・シ・ド（中央ド）です。

このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, lower ledger lines: A, B, and middle C.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q3-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q3'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"A3","voicing":[57],"voicing_names":["A3"],"voicing_staves":[1],"key_fifths":0},{"name":"B3","voicing":[59],"voicing_names":["B3"],"voicing_staves":[1],"key_fifths":0},{"name":"C4","voicing":[60],"voicing_names":["C4"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q3-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q3'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"A3","voicing":[57],"voicing_names":["A3"],"voicing_staves":[1],"key_fifths":0},{"name":"B3","voicing":[59],"voicing_names":["B3"],"voicing_staves":[1],"key_fifths":0},{"name":"C4","voicing":[60],"voicing_names":["C4"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q3-battle'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q3'), NULL, 2, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, false, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q3'), NULL, NULL,
   'バトルモード', 'Battle mode', true)
ON CONFLICT (id) DO UPDATE SET
  order_index = EXCLUDED.order_index,
  survival_random_chords = EXCLUDED.survival_random_chords,
...
INSERT INTO public.lessons (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q4'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'course-reading-notation'),
  'シドレ',
  'B C D',
  'ト音記号・下加線。シ・ド・レの3音です。
...
このクエストでは、①風船ラッシュ → ②サバイバル → ③バトルモードの順に挑戦します。',
  'Treble clef, lower ledger lines: B, C, and D.
...
INSERT INTO public.lesson_songs (
  ...
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q4-balloon'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q4'), NULL, 0, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'notation-balloon-random'), false, NULL,
   '[{"name":"B3","voicing":[59],"voicing_names":["B3"],"voicing_staves":[1],"key_fifths":0},{"name":"C4","voicing":[60],"voicing_names":["C4"],"voicing_staves":[1],"key_fifths":0},{"name":"D4","voicing":[62],"voicing_names":["D4"],"voicing_staves":[1],"key_fifths":0}]'::jsonb, NULL,
   '風船ラッシュ', 'Balloon Rush', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q4-survival'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q4'), NULL, 1, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, true, 1100, 'lesson', false, NULL, false, NULL,
   '[{"name":"B3","voicing":[59],"voicing_names":["B3"],"voicing_staves":[1],"key_fifths":0},{"name":"C4","voicing":[60],"voicing_names":["C4"],"voicing_staves":[1],"key_fifths":0},{"name":"D4","voicing":[62],"voicing_names":["D4"],"voicing_staves":[1],"key_fifths":0}]'::jsonb,
   '{"bgmUrl":"https://jazzify-cdn.com/fantasy-bgm/survival-composite-phrases-drums160-loop.mp3"}'::jsonb,
   'サバイバル', 'Survival', true),
  (uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lsong-b3-q4-battle'), uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-lesson-b3-q4'), NULL, 2, '{"count":1,"rank":"C"}'::jsonb,
   false, NULL, false, NULL, NULL, false, NULL, true,
   uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'rn-ear-b3-q4'), NULL, NULL,
   'バトルモード', 'Battle mode', true)
ON CONFLICT (id) DO UPDATE SET
  order_index = EXCLUDED.order_index,
  survival_random_chords = EXCLUDED.survival_random_chords,
