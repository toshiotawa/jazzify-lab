-- Code Run stage 113: graveyard_run_03 map + developer test course lesson.
-- Existing graveyard assets are reused; layout changes to a spike-lane platform gimmick.
BEGIN;
...
INSERT INTO public.survival_stages (
  ...
  '{
    "lines": [
      {"at_seconds": 2, "speaker": "fai", "text": "足場を使ってスパイク帯を渡ろう。", "text_en": "Use the platforms to cross the spike lanes."},
      {"at_seconds": 9, "speaker": "jajii", "text": "低い足場は単発ジャンプでも届くぞ。", "text_en": "The low platforms are reachable with a single jump."},
      {"at_seconds": 19, "speaker": "fai", "text": "敵の位置を見て、着地先を選んでね。", "text_en": "Watch enemy positions and choose where to land."}
    ]
  }'::jsonb,
  'fade_15s',
  'fade_15s'
...
SELECT
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-03-lesson'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'course-developer-test'),
  'サバイバル: コードラン3（テスト）',
  'Survival: Code Run 3 (test)',
  '既存素材のまま、低い足場とスパイク帯を中心にしたコードランの開発者向けテスト課題です。',
  'Developer test assignment for CodeRun stage 3, reusing the existing assets with a low-platform spike-lane layout.',
  false,
  ...
  'Test',
  '[]'::jsonb,
  '制限時間以内にゴールしてください。足場を使ってスパイク帯を越えます。',
  'Reach the goal before the time limit. Use platforms to cross the spike lanes.'
FROM (
...
INSERT INTO public.lesson_songs (
  ...
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-03-lsong'),
  uuid_generate_v5('a0000000-0000-4000-8000-000000000001'::uuid, 'dev-survival-code-run-03-lesson'),
  NULL,
  0,
