-- Extend guild ranking with guild_type and quest_success_count
...
begin
  ...
  select r.guild_id,
         ...
         s.success_count as quest_success_count,
         r.rank_no
  from ranked r
  left join public.guild_quest_stats s on s.guild_id = r.guild_id
