-- Member cap revert to 5 members (temporary setting back to original)

-- Invite: enforce cap 5
...
-- Accept invitation: enforce cap 5 and cancel others when full
...
-- Approve request: enforce cap 5 and cancel others when full
