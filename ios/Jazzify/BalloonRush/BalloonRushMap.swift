...
/// 風船ラッシュのプレイフィールド（`SurvivalMap` の 1/2）。Web `BALLOON_RUSH_MAP_CONFIG` と同期。
enum BalloonRushMap {
    static let width: CGFloat = SurvivalMap.width / 2
    static let height: CGFloat = SurvivalMap.height / 2
}
