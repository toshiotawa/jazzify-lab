...
enum NotationInstrumentCatalog {
    ...
    static let presets: [NotationInstrumentPreset] = [
        ...
        .init(id: "soprano_sax", clef: .treble, transposition: -2, octaveOffset: 0, labelJa: "ソプラノサックス", labelEn: "Soprano Sax"),
        .init(id: "alto_sax", clef: .treble, transposition: -9, octaveOffset: 0, labelJa: "アルトサックス", labelEn: "Alto Sax"),
        .init(id: "tenor_sax", clef: .treble, transposition: -2, octaveOffset: -1, labelJa: "テナーサックス", labelEn: "Tenor Sax"),
        .init(id: "baritone_sax", clef: .treble, transposition: -9, octaveOffset: -1, labelJa: "バリトンサックス", labelEn: "Baritone Sax"),
