...
const CATEGORY_GROUPS = [
  ...
  },
  {
    ...
    articles: [
      ...
      'online-jazz-piano-lessons-guide',
      'best-online-jazz-piano-course',
      'online-jazz-piano-lessons-cost',
      'jazz-piano-teacher-vs-app',
      'free-jazz-piano-lessons-online',
      'learn-jazz-piano-in-your-browser',
      'jazz-piano-ear-training-app',
      'jazz-piano-lessons-for-classical-pianists',
      'how-long-to-learn-jazz-piano',
      'jazz-piano-books-vs-apps',
      'learn-jazz-piano-as-an-adult',
      'jazz-piano-standards-for-beginners',
      'jazz-piano-autumn-leaves-practice',
      'jazz-piano-blue-bossa-practice',
      'jazz-piano-30-minute-practice-routine',
      'jazz-piano-metronome-two-and-four',
      'jazz-piano-ear-training',
      'jazz-piano-rhythm-practice',
      'jazz-piano-comping-patterns',
      'jazz-piano-practice-schedule-busy-adults',
      'jazz-piano-plateau',
      'jazz-piano-backing-tracks',
      'jazz-piano-fly-me-to-the-moon',
      'jazz-piano-summertime',
      'jazz-piano-all-the-things-you-are',
      'jazz-piano-take-the-a-train',
      'jazz-piano-so-what-modal',
    ],
  },
  {
    ...
    articles: [
      ...
      'jazz-piano-guide-tones',
      'jazz-piano-shell-voicings',
      'jazz-piano-left-hand-bass',
      'jazz-piano-blues-progression',
      'jazz-piano-improvisation-chord-tones',
      'jazz-piano-reharmonization-first-steps',
      'jazz-piano-scales-for-beginners',
      'jazz-piano-turnarounds',
      'jazz-piano-tritone-substitution',
      'jazz-piano-quartal-voicings',
      'jazz-piano-diminished-chords',
      'jazz-piano-pentatonic-scales',
      'jazz-piano-bebop-scales',
      'jazz-piano-chord-melody',
      'jazz-piano-walking-bass-lines',
    ],
  },
  {
    slug: 'gear-setup',
    ...
    articles: [
      ...
      'midi-keyboard-piano-lessons',
      'midi-keyboard-practice',
      'connect-midi-keyboard-ipad',
      'connect-midi-keyboard-iphone',
      'connect-midi-keyboard-mac',
      'connect-midi-keyboard-windows',
      'connect-midi-keyboard-chromebook',
      'midi-keyboard-not-detected-browser',
      '49-vs-61-key-midi-keyboard-jazz',
      '61-vs-88-key-midi-keyboard-jazz',
      'reduce-midi-latency-piano',
      'best-midi-keyboard-for-jazz-piano',
      'midi-piano-learning-software',
      'web-midi-browser-support-piano',
      'midi-keyboard-vs-digital-piano-jazz',
      'weighted-vs-synth-action-keys-jazz',
      'midi-sustain-pedal-setup',
    ],
  },
];
